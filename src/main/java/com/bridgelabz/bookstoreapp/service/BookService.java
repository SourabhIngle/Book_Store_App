...
//========================================================================
    ...
    public BookModel changeBookQty(String token, int bookId, int quantity) {
...
//    CURD OPERATION
    ...
    public ResponseDTO add(BookDTO bookDTO) {
        ...
        bookRepository.save(bookModel);
        String token = jwtToken.createToken(bookModel.getBook_id());
        return new ResponseDTO(token, bookModel);
    }
